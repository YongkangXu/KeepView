//
//  J0TimeInterval.swift 
//
//  Created by chen on 16/11/23.
//  Copyright © 2016年 cn.j0. All rights reserved.
//

import Foundation

public struct J0TimeInterval{
    ...
    public static func string(_ digital : J0TimeInterval.Digital, timeInterval : TimeInterval) -> String {

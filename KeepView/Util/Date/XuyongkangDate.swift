//
//  XuyongkangDate.swift
//
//  Created by Xuyongkang on 12/31/15.
//  Copyright © 2015 cn.Xuyongkang. All rights reserved.
//

import Foundation

fileprivate struct XuyongkangDateConst{
...
public class XuyongkangDate{
    
    private init(){}
    
    public static var nowString : String{
        return XuyongkangDate.stringFrom(formatterString: "yyyy-MM-dd HH:mm:ss")
    }
    ...
    public static func isDay(date : Date, fromDate : Date = Date()) -> Bool{
        return XuyongkangDate.integer(date: date) == XuyongkangDate.integer(date: fromDate)
    }
    
    public static func isYear(date : Date, yearDate : Date = Date()) -> Bool{
        return XuyongkangDate.stringFrom(date: date, formatterString: "yyyy") == XuyongkangDate.stringFrom(date: yearDate, formatterString: "yyyy")
    }
    
    public static func integer(date : Date) -> Int?{
        return Int(XuyongkangDate.stringFrom(date: date, formatterString: "yyyyMMdd"))
    }
...
fileprivate typealias XuyongkangDateMethod = XuyongkangDate
public extension XuyongkangDateMethod{
    ...
    public static func friendly(date: Date) -> String {
        ...
        if compsDate.year != newCompsDate.year{
            return XuyongkangDate.stringFrom(date: date, formatterString: "yyyy\(XuyongkangDateConst.YearString)MM\(XuyongkangDateConst.MonthString)dd\(XuyongkangDateConst.DayString) a HH:mm")
        }
        ...
        if let compsDateDay = compsDate.day, let newCompsDateDay = newCompsDate.day {
            ...
            if let compsDateMonth = compsDate.month, let newCompsDateMonth = newCompsDate.month, compsDateMonth != newCompsDateMonth || abs(compsDateDay - newCompsDateDay) > 1 {
                ...
                return XuyongkangDate.stringFrom(date: date, formatterString: "MM\(XuyongkangDateConst.MonthString)dd\(XuyongkangDateConst.DayString) a HH:mm")
                
            } else if compsDateDay == newCompsDateDay + 1 {
                
                return XuyongkangDateConst.TomorrowString + " | " + XuyongkangDate.stringFrom(date: date, formatterString: "a HH:mm")
                
            } else if compsDateDay == newCompsDateDay - 1{
                
                return XuyongkangDateConst.YesterdayString + " | " + XuyongkangDate.stringFrom(date: date, formatterString: "a HH:mm")
            }
        }
        ...
        if let compsDateHour = compsDate.hour, let newCompsDateHour = newCompsDate.hour, let compsDateMinute = compsDate.minute, let newCompsDateMinute = newCompsDate.minute{
            ...
            if difference >= -1 && difference <= 1{
                ...
                if difference == 1 {
                    return "\(1)" + XuyongkangDateConst.AfterMinuteString
                } else if difference <= -1{
                    return "\(1)" + XuyongkangDateConst.AgoMinuteString
                    ...
                    if differenceSecond > 0{
                        return "\(differenceSecond)" + XuyongkangDateConst.AfterSecondString
                    }
                    else if differenceSecond < 0{
                        return "\(abs(differenceSecond))" + XuyongkangDateConst.AgoSecondString
                    }
                }
                return XuyongkangDateConst.JustString
            } else if difference > 0 && difference < 60{
                return "\(difference)" + XuyongkangDateConst.AfterMinuteString
            } else if difference < 0 && difference > -60{
                return "\(abs(difference))" + XuyongkangDateConst.AgoMinuteString
            }
        }
        
        return XuyongkangDateConst.NowadaysString + " | " + XuyongkangDate.stringFrom(date: date, formatterString: "a HH:mm")
    }
    
    
    public static func friendly(dateString: String , formatterString : String) -> String? {
        
        if let date = XuyongkangDate.dateFrom(dateString: dateString, formatterString: formatterString){
    ...
    public static func nearFuture(date: Date) -> String {
        ...
        if compsDate.year != newCompsDate.year{
            return XuyongkangDate.stringFrom(date: date, formatterString: "yyyy\(XuyongkangDateConst.YearString)MM\(XuyongkangDateConst.MonthString)dd\(XuyongkangDateConst.DayString) ")
        }
        ...
        if let compsDateDay = compsDate.day, let newCompsDateDay = newCompsDate.day {
            ...
            if let compsDateMonth = compsDate.month, let newCompsDateMonth = newCompsDate.month, compsDateMonth != newCompsDateMonth || abs(compsDateDay - newCompsDateDay) > 1 {
                ...
                return XuyongkangDate.stringFrom(date: date, formatterString: "MM\(XuyongkangDateConst.MonthString)dd\(XuyongkangDateConst.DayString)")
